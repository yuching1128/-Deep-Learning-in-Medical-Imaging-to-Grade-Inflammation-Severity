...
#with tf.device('/cpu:0'):   
    ...
    training_set = train_datagen.flow_from_directory('C:/Users/ESA.DESKTOP-NTEFSD9/.spyder-py3/dataset_CNN1/training',
    target_size = (128,128),
    batch_size = 32,
    color_mode="rgb",
    ...
    test_set = test_datagen.flow_from_directory('C:/Users/ESA.DESKTOP-NTEFSD9/.spyder-py3/dataset_CNN1/testing',
    target_size = (128, 128),
    batch_size = 32,
    color_mode="rgb",
    class_mode="categorical",
    ...
    steps_per_epoch = 200,  #8000 3000 STEP_SIZE_TRAINt rain_num/64
    epochs = 25,  #25
    validation_data = test_set,
    validation_steps =50) #500
  
    classifier.save_weights("graph_CNN1.h5")    
...
#plt.show()
plt.savefig('C:/Users/ESA.DESKTOP-NTEFSD9/Desktop/graph_CNN1/graph_CNN1_accuracy.png')
plt.close()
...
plt.legend(['train', 'test'], loc='upper left')
#plt.show()
plt.savefig('C:/Users/ESA.DESKTOP-NTEFSD9/Desktop/graph_CNN1/graph_CNN1_loss.png')
plt.close()


f = open('C:/Users/ESA.DESKTOP-NTEFSD9/Desktop/graph_CNN1/history.txt', 'a', encoding = 'UTF-8')    # 也可使用指定路徑等方式，如： C:\A.txt
f.write('graph_CNN1 SGD\n')
f.write('acc,  ')
